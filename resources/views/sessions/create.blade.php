    ...
    <section class="h-screen max-w-[1140px] mx-auto space-y-2">
        <div class="flex h-full items-center gap-20 px-10 py-5">
            ...
            <div class="flex-1 h-[740px]">
                <img src="{{file_exists(public_path('storage/images/cover_image.png')) ? asset('storage/images/cover_image.png') . '?' . now()->timestamp : asset('basic-images/intersect.png')}}" class="rounded-l-xl h-full object-cover"/>
            </div>
