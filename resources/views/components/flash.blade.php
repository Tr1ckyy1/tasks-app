...
<div id="toast-warning" class="absolute left-1/2 top-4 -translate-x-1/2 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow border-b border-b-orange-500" role="alert">
