...
@elseif(session()->has('deleted'))
    <div x-data="{show: true}"
         x-init="setTimeout(() => show = false,3000)"
         x-show="show" id="toast-danger" class="absolute left-1/2 top-4 -translate-x-1/2 flex items-center  max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow border-b border-b-main-red" role="alert">
