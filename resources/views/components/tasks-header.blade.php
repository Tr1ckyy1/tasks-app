...
<header class="flex justify-between w-full">
    ...
    @if($task ?? null)
        <a href="{{route('tasks.edit', ['task' => $task])}}" class="max-h-[50px] uppercase border border-main-blue py-3 px-6 rounded-[14px] text-main-blue font-bold duration-100 flex gap-4 items-center hover:bg-[#f6faff]">
